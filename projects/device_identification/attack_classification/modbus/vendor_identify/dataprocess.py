...
def train_test_split_labeled_ip(labeled_ip_data_dict, ratio):
    ...
    train_labeled_ip_df = pd.read_csv(os.path.join(data_path, "modbus_vendor_train_ip_list.csv"))
    train_labeled_ip_set = set(train_labeled_ip_df["train_ip"])

    test_labeled_ip_df = pd.read_csv(os.path.join(data_path, "modbus_vendor_test_ip_list.csv"))
